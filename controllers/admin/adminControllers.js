...
export const addBooks = async (req, res) => {
    ...
    const newBook = new Book({...createNew});
...
export const editBookDetails = async (req, res) => {
    ...
    try {
        await Book.findByIdAndRemove(toEdit._id);
        const updated = { _id: toEdit._id, ...toEdit };
        const newBook = new Book({...updated})    //edit without changing book ID
        await newBook.save();
